    ...
    return (
        <>
            {isOpen && <div className="fixed flex justify-center top-0 items-center bottom-0">
                ...
                <form onSubmit={onClick}  className="bg-white sm:w-1/2 sm:px-20 px-8 h-[85%] py-10 pt-18 rounded-3xl shadow-xl overflow-y-scroll relative z-30">
                    <div className="text-center underline font-semibold text-md maroon absolute w-full bg-gray-200 top-0 -left-0 p-4">Your Details</div>
