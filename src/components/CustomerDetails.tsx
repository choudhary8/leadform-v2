    ...
    return (
        <>
            {isOpen && <div className="fixed flex justify-center top-0 items-center bottom-0">
                ...
                <div className="bg-white w-1/2 px-20 py-10  rounded-lg overflow-y-scroll z-10">
                    ...
                    <button onClick={onClick} className="py-4 px-10 bg-[#f27b1a] rounded-lg">Next</button>
                </div>
            </div>}
        </>
    )
